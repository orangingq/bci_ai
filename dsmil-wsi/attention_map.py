...
if __name__ == '__main__':
    ...
    if args.embedder_weights == 'ImageNet':
        ...
        resnet = models.resnet18(weights="IMAGENET1K_V1", norm_layer=nn.BatchNorm2d)
    else:
        resnet = models.resnet18(norm_layer=nn.InstanceNorm2d)
    ...
    if args.embedder_weights !=  'ImageNet':
        state_dict_weights = torch.load(args.embedder_weights, weights_only=True)
    ...
    state_dict_weights = torch.load(args.aggregator_weights, weights_only=True) 
